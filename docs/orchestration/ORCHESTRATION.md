...
## 2. Pipeline — 10 etapów + 1 orkiestrator
...
flowchart TD
    ...
    A9 --> A10[10. Raport Retrospektywny]
    A10 -->|propozycje ulepszeń promptów| O
```
...
| 10 | `10-retrospective-reporter.agent.md` | Raport końcowy + propozycje ulepszeń agentów | wszystkie artefakty | `docs/reports/retrospective-<slug>.md` |
...
3. Orkiestrator:
   - utworzy listę TODO odzwierciedlającą 10 etapów,
   ...
   - na końcu przedstawi raport retrospektywny i zapyta, czy wdrożyć proponowane ulepszenia
     promptów agentów.
4. Każdy artefakt trafia do `docs/**` — możesz przeglądać historię decyzji w Git.

## 5. Zasady bezpieczeństwa i higieny pracy agentów
